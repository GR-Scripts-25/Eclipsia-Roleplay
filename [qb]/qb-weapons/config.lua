...
Config.ReloadTime = math.random(1, 1)
...
Config.AmmoTypes = {
    ...
    flair_ammo = 'AMMO_FLARE',
    slingshot_ammo = 'AMMO_SINGLESHOT',
    revolver_ammo = 'AMMO_REVOLVER',
    smg_ammo = 'AMMO_SMG',
    shotgun_ammo = 'AMMO_SHOTGUN',
    musket_ammo = 'AMMO_MUSKET',
    rifle_ammo = 'AMMO_RIFLE',
    mg_ammo = 'AMMO_MG',
    snp_ammo = 'AMMO_SNIPER',
}
...
Config.MaxAmmo = {
    ...
    weapon_ceramicpistol = 12,
    weapon_navyrevolver = 6,
