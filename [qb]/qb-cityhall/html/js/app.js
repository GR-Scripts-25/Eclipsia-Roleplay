...
document.addEventListener('DOMContentLoaded', function() {
    const closeBtns = document.querySelectorAll('#mtcCityhall .qb-cityhall .qb-cityhall-header .mtc-button.red, #mtcCityhall .qb-cityhall .qb-cityhall-header .mtc-button.green, #mtcCityhall .qb-cityhall .qb-cityhall-header .mtc-button.yellow');
    closeBtns.forEach(function(btn) {
        btn.addEventListener('click', function() {
            if (typeof main !== 'undefined' && main.HideCityhall) {
                main.HideCityhall();
            }
        });
    });
