RegisterNetEvent('qb-carwash:DoVehicleWashParticles', function(vehNet, use_props)
    local src = source
    TriggerClientEvent('qb-carwash:DoVehicleWashParticles', -1, vehNet, src, use_props)
end)

RegisterCallback('qb-carwash:CanPurchaseCarWash', function(source, cb)
    local src = source
