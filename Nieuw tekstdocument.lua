...
QBShared.Items = {
    ...
    weapon_marksmanpistol     = { name = 'weapon_marksmanpistol', label = 'Marksman Pistol', weight = 1000, type = 'weapon', ammotype = 'AMMO_SINGLESHOT', image = 'weapon_marksmanpistol.png', unique = true, useable = false, description = 'A very accurate small firearm designed to be held in one hand' },
    weapon_revolver           = { name = 'weapon_revolver', label = 'Revolver', weight = 1000, type = 'weapon', ammotype = 'AMMO_REVOLVER', image = 'weapon_revolver.png', unique = true, useable = false, description = 'A pistol with revolving chambers enabling several shots to be fired without reloading' },
    weapon_revolver_mk2       = { name = 'weapon_revolver_mk2', label = 'Violence', weight = 1000, type = 'weapon', ammotype = 'AMMO_REVOLVER', image = 'weapon_revolver_mk2.png', unique = true, useable = true, description = 'da Violence' },
    weapon_doubleaction       = { name = 'weapon_doubleaction', label = 'Double Action Revolver', weight = 1000, type = 'weapon', ammotype = 'AMMO_REVOLVER', image = 'weapon_doubleaction.png', unique = true, useable = true, description = 'Double Action Revolver' },
    ...
    weapon_navyrevolver       = { name = 'weapon_navyrevolver', label = 'Navy Revolver', weight = 1000, type = 'weapon', ammotype = 'AMMO_REVOLVER', image = 'weapon_navyrevolver.png', unique = true, useable = true, description = 'Weapon Navyrevolver' },
    ...
    weapon_musket             = { name = 'weapon_musket', label = 'Musket', weight = 1000, type = 'weapon', ammotype = 'AMMO_MUSKET', image = 'weapon_musket.png', unique = true, useable = false, description = 'An infantryman\'s light gun with a long barrel, typically smooth-bored, muzzleloading, and fired from the shoulder' },
    ...
    -- Light Machine Guns
    weapon_mg                 = { name = 'weapon_mg', label = 'Machinegun', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'weapon_mg.png', unique = true, useable = false, description = 'An automatic gun that fires bullets in rapid succession for as long as the trigger is pressed' },
    weapon_combatmg           = { name = 'weapon_combatmg', label = 'Combat MG', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'weapon_combatmg.png', unique = true, useable = false, description = 'A combat version of an automatic gun that fires bullets in rapid succession for as long as the trigger is pressed' },
    weapon_gusenberg          = { name = 'weapon_gusenberg', label = 'Thompson SMG', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'weapon_gusenberg.png', unique = true, useable = false, description = 'An automatic rifle commonly referred to as a tommy gun' },
    weapon_combatmg_mk2       = { name = 'weapon_combatmg_mk2', label = 'Combat MG Mk II', weight = 1000, type = 'weapon', ammotype = 'AMMO_SMG', image = 'weapon_combatmg_mk2.png', unique = true, useable = true, description = 'Weapon Combatmg MK2' },
    ...
    -- Ammo ITEMS
    pistol_ammo               = { name = 'pistol_ammo', label = 'Pistol Ammo', weight = 1000, type = 'item', image = 'pistol_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Pistol' },
    flair_ammo                = { name = 'flair_ammo', label = 'Flair Ammo', weight = 1000, type = 'item', image = 'flair_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Flair' },
    slingshot_ammo            = { name = 'slingshot_ammo', label = 'Slingshot Ammo', weight = 1000, type = 'item', image = 'slingshot_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Slingshot' },
    revolver_ammo             = { name = 'revolver_ammo', label = 'Revolver Ammo', weight = 1000, type = 'item', image = 'revolver_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Revolver' },
    smg_ammo                  = { name = 'smg_ammo', label = 'SMG Ammo', weight = 1000, type = 'item', image = 'smg_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for SMG' },
    shotgun_ammo              = { name = 'shotgun_ammo', label = 'Shotgun Ammo', weight = 1000, type = 'item', image = 'shotgun_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Shotgun' },
    musket_ammo               = { name = 'musket_ammo', label = 'Musket Ammo', weight = 1000, type = 'item', image = 'musket_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Musket' },
    rifle_ammo                = { name = 'rifle_ammo', label = 'Rifle Ammo', weight = 1000, type = 'item', image = 'rifle_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Rifle' },
    mg_ammo                   = { name = 'mg_ammo', label = 'MG Ammo', weight = 1000, type = 'item', image = 'mg_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for MG' },
    snp_ammo                  = { name = 'snp_ammo', label = 'Sniper Ammo', weight = 1000, type = 'item', image = 'snp_ammo.png', unique = false, useable = true, shouldClose = true, description = 'Ammo for Sniper' },
